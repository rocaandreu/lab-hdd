...
module mult_add_pipeline_mult_add_pipeline_core_core_fsm (
  ...
  always @(*)
  begin : mult_add_pipeline_mult_add_pipeline_core_core_fsm_1
    case (state_var)
      main_C_0 : begin
        fsm_output = 2'b10;
...
module mult_add_pipeline_mult_add_pipeline_core_staller (
...
module mult_add_pipeline_mult_add_pipeline_core_gain_adjust_rsc_triosy_obj_gain_adjust_rsc_triosy_wait_ctrl
    (
...
module mult_add_pipeline_mult_add_pipeline_core_gain_rsc_triosy_obj_gain_rsc_triosy_wait_ctrl
    (
...
module mult_add_pipeline_mult_add_pipeline_core_result_rsci_result_wait_dp (
...
module mult_add_pipeline_mult_add_pipeline_core_result_rsci_result_wait_ctrl (
...
module mult_add_pipeline_mult_add_pipeline_core_c_rsci_c_wait_dp (
...
module mult_add_pipeline_mult_add_pipeline_core_c_rsci_c_wait_ctrl (
...
module mult_add_pipeline_mult_add_pipeline_core_b_rsci_b_wait_dp (
...
module mult_add_pipeline_mult_add_pipeline_core_b_rsci_b_wait_ctrl (
...
module mult_add_pipeline_mult_add_pipeline_core_wait_dp (
...
module mult_add_pipeline_mult_add_pipeline_core_a_rsci_a_wait_dp (
...
module mult_add_pipeline_mult_add_pipeline_core_a_rsci_a_wait_ctrl (
...
module mult_add_pipeline_mult_add_pipeline_core_gain_adjust_rsc_triosy_obj (
  ...
  // Interconnect Declarations for Component Instantiations 
  mult_add_pipeline_mgc_io_sync_v2 #(.valid(32'sd0)) gain_adjust_rsc_triosy_obj (
...
module mult_add_pipeline_mult_add_pipeline_core_gain_rsc_triosy_obj (
  ...
  // Interconnect Declarations for Component Instantiations 
  mult_add_pipeline_mgc_io_sync_v2 #(.valid(32'sd0)) gain_rsc_triosy_obj (
      .ld(gain_rsc_triosy_obj_biwt),
      .lz(gain_rsc_triosy_lz)
    );
  mult_add_pipeline_mult_add_pipeline_core_gain_rsc_triosy_obj_gain_rsc_triosy_wait_ctrl
      mult_add_pipeline_core_gain_rsc_triosy_obj_gain_rsc_triosy_wait_ctrl_inst (
      .core_wten(core_wten),
...
module mult_add_pipeline_mult_add_pipeline_core_result_rsci (
  ...
  mult_add_pipeline_ccs_out_buf_wait_v5 #(.rscid(32'sd6),
  .width(32'sd30),
  .ph_clk(32'sd1),
  .ph_en(32'sd0),
  .ph_arst(32'sd0),
  ...
  mult_add_pipeline_mult_add_pipeline_core_result_rsci_result_wait_ctrl mult_add_pipeline_core_result_rsci_result_wait_ctrl_inst
      (
      .core_wen(core_wen),
  ...
  mult_add_pipeline_mult_add_pipeline_core_result_rsci_result_wait_dp mult_add_pipeline_core_result_rsci_result_wait_dp_inst
      (
      .clk(clk),
      .rst(rst),
      .result_rsci_oswt(result_rsci_oswt),
...
module mult_add_pipeline_mult_add_pipeline_core_c_rsci (
  ...
  // Interconnect Declarations for Component Instantiations 
  mult_add_pipeline_ccs_ctrl_in_buf_wait_v4 #(.rscid(32'sd3),
  .width(32'sd25),
  .ph_clk(32'sd1),
  .ph_en(32'sd0),
  .ph_arst(32'sd0),
  ...
  mult_add_pipeline_mult_add_pipeline_core_c_rsci_c_wait_ctrl mult_add_pipeline_core_c_rsci_c_wait_ctrl_inst
      (
      .core_wen(core_wen),
  ...
  mult_add_pipeline_mult_add_pipeline_core_c_rsci_c_wait_dp mult_add_pipeline_core_c_rsci_c_wait_dp_inst
      (
      .clk(clk),
      .rst(rst),
      .c_rsci_oswt(c_rsci_oswt),
...
module mult_add_pipeline_mult_add_pipeline_core_b_rsci (
  ...
  // Interconnect Declarations for Component Instantiations 
  mult_add_pipeline_ccs_ctrl_in_buf_wait_v4 #(.rscid(32'sd2),
  .width(32'sd14),
  .ph_clk(32'sd1),
  .ph_en(32'sd0),
  .ph_arst(32'sd0),
  ...
  mult_add_pipeline_mult_add_pipeline_core_b_rsci_b_wait_ctrl mult_add_pipeline_core_b_rsci_b_wait_ctrl_inst
      (
      .core_wen(core_wen),
  ...
  mult_add_pipeline_mult_add_pipeline_core_b_rsci_b_wait_dp mult_add_pipeline_core_b_rsci_b_wait_dp_inst
      (
      .clk(clk),
      .rst(rst),
      .b_rsci_oswt(b_rsci_oswt),
...
module mult_add_pipeline_mult_add_pipeline_core_a_rsci (
  ...
  // Interconnect Declarations for Component Instantiations 
  mult_add_pipeline_ccs_ctrl_in_buf_wait_v4 #(.rscid(32'sd1),
  .width(32'sd11),
  .ph_clk(32'sd1),
  .ph_en(32'sd0),
  .ph_arst(32'sd0),
  ...
  mult_add_pipeline_mult_add_pipeline_core_a_rsci_a_wait_ctrl mult_add_pipeline_core_a_rsci_a_wait_ctrl_inst
      (
      .core_wen(core_wen),
  ...
  mult_add_pipeline_mult_add_pipeline_core_a_rsci_a_wait_dp mult_add_pipeline_core_a_rsci_a_wait_dp_inst
      (
      .clk(clk),
      .rst(rst),
      .a_rsci_oswt(a_rsci_oswt),
...
module mult_add_pipeline_mult_add_pipeline_core (
  ...
  assign nl_mult_add_pipeline_core_result_rsci_inst_result_rsci_idat = {result_rsci_idat_29_4
      , 4'b0000};
  mult_add_pipeline_ccs_in_v1 #(.rscid(32'sd4),
  .width(32'sd10)) gain_rsci (
      .dat(gain_rsc_dat),
      .idat(gain_rsci_idat)
    );
  mult_add_pipeline_ccs_in_v1 #(.rscid(32'sd5),
  .width(32'sd1)) gain_adjust_rsci (
      .dat(gain_adjust_rsc_dat),
      .idat(gain_adjust_rsci_idat)
    );
  mult_add_pipeline_mult_add_pipeline_core_a_rsci mult_add_pipeline_core_a_rsci_inst
      (
      .clk(clk),
      .rst(rst),
      .a_rsc_dat(a_rsc_dat),
  ...
  mult_add_pipeline_mult_add_pipeline_core_wait_dp mult_add_pipeline_core_wait_dp_inst
      (
      .clk(clk),
      .rst(rst),
  ...
  mult_add_pipeline_mult_add_pipeline_core_b_rsci mult_add_pipeline_core_b_rsci_inst
      (
      .clk(clk),
      .rst(rst),
      .b_rsc_dat(b_rsc_dat),
  ...
  mult_add_pipeline_mult_add_pipeline_core_c_rsci mult_add_pipeline_core_c_rsci_inst
      (
      .clk(clk),
      .rst(rst),
      .c_rsc_dat(c_rsc_dat),
  ...
  mult_add_pipeline_mult_add_pipeline_core_result_rsci mult_add_pipeline_core_result_rsci_inst
      (
      .clk(clk),
      .rst(rst),
  ...
  mult_add_pipeline_mult_add_pipeline_core_gain_rsc_triosy_obj mult_add_pipeline_core_gain_rsc_triosy_obj_inst
      (
      .gain_rsc_triosy_lz(gain_rsc_triosy_lz),
      .core_wten(core_wten),
      .gain_rsc_triosy_obj_iswt0(reg_gain_adjust_rsc_triosy_obj_iswt0_cse)
    );
  mult_add_pipeline_mult_add_pipeline_core_gain_adjust_rsc_triosy_obj mult_add_pipeline_core_gain_adjust_rsc_triosy_obj_inst
      (
  ...
  mult_add_pipeline_mult_add_pipeline_core_staller mult_add_pipeline_core_staller_inst
      (
      .clk(clk),
      .rst(rst),
  ...
  mult_add_pipeline_mult_add_pipeline_core_core_fsm mult_add_pipeline_core_core_fsm_inst
      (
      .clk(clk),
      .rst(rst),
      .core_wen(core_wen),
...
module mult_add_pipeline (
  ...
  assign nl_mult_add_pipeline_core_inst_product_mul_cmp_z = conv_u2u_25_25(product_mul_cmp_a
      * product_mul_cmp_b);
  mult_add_pipeline_mult_add_pipeline_core mult_add_pipeline_core_inst (
      .clk(clk),
      .rst(rst),
      .a_rsc_dat(a_rsc_dat),
      .a_rsc_vld(a_rsc_vld),
