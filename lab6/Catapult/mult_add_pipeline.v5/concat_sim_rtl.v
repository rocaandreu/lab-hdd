...
//  Generated date: Thu Nov 21 17:59:23 2024
// ----------------------------------------------------------------------
...
module mult_add_pipeline_core (
  ...
  assign nl_sum_sva_2 = conv_u2u_25_26(product_mul_itm_1) + conv_u2u_25_26(sum_c_tmp_sva_1);
  assign sum_sva_2 = nl_sum_sva_2[25:0];
  always @(posedge clk) begin
    if ( rst ) begin
  ...
  always @(posedge clk) begin
    ...
    else if ( core_wen & reg_gain_adjust_rsc_triosy_obj_iswt0_cse ) begin
  ...
  assign and_3_nl = main_stage_0_3 & (~ CHECK_io_read_gain_adjust_rsc_svs_2);
  assign nl_operator_10_2_true_AC_TRN_AC_WRAP_26_false_mul_nl = $signed(conv_u2s_26_27(sum_sva_2))
      * $signed(gain_sva_1);
